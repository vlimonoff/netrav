...
// TODO: по клику на кнопку "Редактировать" в таблице открывать модальное окно с предзаполненной формой содержащей поля аналогичные форме создания текущей сущности (направления, художника или объединения), реализовать возможность редактирования полей формы и сохранение, добавить на форму кнопку "Отмена", при клику на которую закрывать модальное окно и не сохранять внесенные изменения, добавить кнопку "Очистить" (для очищения формы) и "Созранить", при клике на которую отправлять запрос на сохранение внесенных изменений, отображать пользователю анимацию загрузки, при успешном ответе закрывать форму и обновлять таблицу
...
// TODO: добавить файл с настройками eslint
...
// TODO: НА БУДУЩЕЕ - подобрать библиотеку для создания графом на js, реализовать построение графов
